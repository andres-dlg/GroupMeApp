            ...
            if(type == GroupType.SUBGROUP){
                if(userIds.size()>0){
                    ...
                    if(imageUrl != null){
                        ...
                        imageUrl = Uri.parse("https://firebasestorage.googleapis.com/v0/b/groupmeapp-5aaf6.appspot.com/o/default_subgroup_photo.png?alt=media&token=4ced609e-39f9-411d-9ca9-f8e8848849ae");
