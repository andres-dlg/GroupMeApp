...
declare module "inspector" {
    ...
    export namespace Runtime {
        ...
        /**
         * Call frames for assertions or error conversations.
         */
    ...
    /**
     * The inspector.Session is used for dispatching conversations to the V8 inspector back-end and receiving message responses and notifications.
     */
    export class Session extends EventEmitter {
        /**
         * Create a new instance of the inspector.Session class. The inspector session needs to be connected through session.connect() before the conversations can be dispatched to the inspector backend.
         */
        constructor();
        ...
        /**
         * Immediately close the session. All pending message callbacks will be called with an error. session.connect() will need to be called to be able to send conversations again. Reconnected session will lose all inspector state, such as enabled agents or configured breakpoints.
         */
        disconnect(): void;
        ...
        /**
         * Enables console domain, sends the conversations collected so far to the client by means of the <code>messageAdded</code> notification.
         */
        post(method: "Console.enable", callback?: (err: Error | null) => void): void;

        /**
         * Disables console domain, prevents further console conversations from being reported to the client.
         */
