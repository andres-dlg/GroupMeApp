...
* Retain original expectation conversations, for failed mocks under sinon.test
  (Giorgos Giannoutsos)
...
* Improved toString method for spies and stubs which leads to more
  precise error conversations from sinon.assert.*
...
* Vastly improved error conversations from assertions
