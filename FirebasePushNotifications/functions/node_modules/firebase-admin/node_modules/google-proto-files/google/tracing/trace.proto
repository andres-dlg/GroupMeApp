...
message Span {
  ...
  message TimeEvent {
    ...
    message NetworkEvent {
      ...
      // For sent conversations, this is the time at which the first bit was sent.
      // For received conversations, this is the time at which the last bit was
      // received.
      ...
      // network conversations in this span.
