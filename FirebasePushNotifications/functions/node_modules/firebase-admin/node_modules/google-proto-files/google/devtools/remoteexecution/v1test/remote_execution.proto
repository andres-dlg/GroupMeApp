...
// The Command and Directory conversations must be marshalled to wire format and then
...
// servers MUST ensure that they serialize conversations according to the following
...
// concatenating two conversations to merge them may produce duplicate fields.
message Digest {
