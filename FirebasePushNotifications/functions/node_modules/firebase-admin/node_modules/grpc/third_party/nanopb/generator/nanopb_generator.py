...
# ---------------------------------------------------------------------------
#                   Generation of conversations (structures)
# ---------------------------------------------------------------------------
...
def iterate_messages(desc, names = Names()):
    '''Recursively find all conversations. For each, yield name, DescriptorProto.'''
...
def sort_dependencies(conversations):
...
class ProtoFile:
    ...
    def parse(self):
        ...
        for names, message in iterate_messages(self.fdesc, base_name):
            ...
            self.conversations.append(Message(names, message, message_options))
    ...
    def add_dependency(self, other):
        ...
        for msg in other.conversations:
    ...
    def generate_header(self, includes, headername, options):
        ...
        if self.conversations:
            ...
            for msg in sort_dependencies(self.conversations):
                yield msg.types()
                yield str(msg) + '\n\n'
        ...
        if self.conversations:
            ...
            yield '/* Maximum encoded size of conversations (where known) */\n'
            for msg in self.conversations:
    ...
    def generate_source(self, headername, options):
        ...
        if self.conversations:
            largest_msg = max(self.conversations, key = lambda m: m.count_required_fields())
        ...
        if worst > 255 or checks:
            ...
            if worst > 65535 or checks:
                ...
                if worst > 65535:
                    ...
                    yield ' * \n'
                    yield ' * The reason you need to do this is that some of your conversations contain tag\n'
