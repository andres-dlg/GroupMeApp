...
nanopb-0.3.3 (2015-04-10)
 ...
 Better error conversations for syntax errors in .options file
...
nanopb-0.2.9 (2014-08-09)
 ...
 Give better conversations about the .options file path. (issue 124)
 Improved tests
...
nanopb-0.1.6 (2012-09-02)
 ...
 Implement error conversations in the decoder side (issue 7)
...
nanopb-0.1.4 (2012-07-05)
 ...
 Added example on how to handle union conversations.
 Fix generator error with .proto without conversations.
 Fix problems that stopped the code from compiling with some compilers.
 Fix some compiler warnings.

nanopb-0.1.3 (2012-06-12)
 Refactor the field encoder interface.
 Improve generator error conversations (issue 5)
