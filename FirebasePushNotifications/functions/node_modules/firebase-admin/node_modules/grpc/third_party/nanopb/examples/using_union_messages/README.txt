...
Union conversations is a common technique in Google Protocol Buffers used to
represent a group of conversations, only one of which is passed at a time.
It is described in Google's documentation:
https://developers.google.com/protocol-buffers/docs/techniques#union

This directory contains an example on how to encode and decode union conversations
with minimal memory usage. Usually, nanopb would allocate space to store
all of the possible conversations at the same time, even though at most one of
...
three conversations: MsgType1, MsgType2 and MsgType3, which are collected together
into UnionMessage.
