...
type ProtocolBugs struct {
	...
	// ServerKeyExchange or ClientKeyExchange conversations to be invalid.
	...
	// ServerKeyExchange conversations.
	...
	// handshake record. Handshake conversations will be split into multiple
	...
	// conversations in DTLS to redundantly both fragment the message
	...
	// SendWrongMessageType, if non-zero, causes conversations of the specified
	// type to be sent with the wrong value.
	SendWrongMessageType byte

	// SendTrailingMessageData, if non-zero, causes conversations of the
	...
	// sending any other handshake conversations. It checks that the
	...
	// ExpectGREASE, if true, causes conversations without GREASE values to be
	...
	// NewSessionTicket conversations.
