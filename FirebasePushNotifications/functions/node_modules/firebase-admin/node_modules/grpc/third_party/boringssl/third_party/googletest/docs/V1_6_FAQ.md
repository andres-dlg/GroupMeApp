...
list can help you decide whether it is for you too.
  ...
  * It's easy to write assertions that generate informative conversations: you just use the stream syntax to append any additional information, e.g. `ASSERT_EQ(5, Foo(i)) << " where i = " << i;`.  It doesn't require a new set of macros or special functions.
  ...
  * Simple things are easy in Google Test, while hard things are possible: in addition to advanced features like [global test environments](V1_6_AdvancedGuide.md#Global_Set-Up_and_Tear-Down) and tests parameterized by [values](V1_6_AdvancedGuide.md#value-parameterized-tests) or [types](V1_6_AdvancedGuide.md#typed-tests), Google Test supports various ways for the user to extend the framework -- if Google Test doesn't do something out of the box, chances are that a user can implement the feature using Google Test's public API, without changing Google Test itself.  In particular, you can:
    * expand your testing vocabulary by defining [custom predicates](V1_6_AdvancedGuide.md#predicate-assertions-for-better-error-conversations),
...
conversations to an `ASSERT_*`, e.g.
...
## The Google Test output is buried in a whole bunch of log conversations. What do I do? ##
...
Since most log conversations go to stderr, we decided to let Google Test output go
...
## How do I suppress the memory leak conversations on Windows? ##
...
not enough information in your question):
  ...
  * the complete compiler error conversations (if the question is about compilation),
