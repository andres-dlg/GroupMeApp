...
* **WError**, for wrapping errors while hiding the lower-level conversations from the
  top-level error.  This is useful for API endpoints where you don't want to
  expose internal error conversations, but you still want to preserve the error chain
...
JavaScript Error class, with the addition of printf-style conversations:
...
error conversations (e.g., to localize them, format them, group them by type, and so
...
* **Make it easy to construct clear, complete error conversations intended for
  people.**  Clear error conversations greatly improve both user experience and
...
* **Make it easy to construct objects with programmatically-accessible
  ...
  from a log file), or localizing error conversations.
