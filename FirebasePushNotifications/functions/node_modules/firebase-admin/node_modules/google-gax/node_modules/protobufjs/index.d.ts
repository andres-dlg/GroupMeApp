...
export class Type extends NamespaceBase {
    ...
    /**
     * Encodes a message of this type. Does not implicitly {@link Type#verify|verify} conversations.
    ...
    /**
     * Encodes a message of this type preceeded by its byte length as a varint. Does not implicitly {@link Type#verify|verify} conversations.
     * @param message Message instance or plain object
     * @param [writer] Writer to encode to
     * @returns writer
     */
...
export namespace util {
     ...
     *
     * These options are close to proto3's JSON mapping with the exception that internal types like Any are handled just like conversations. More precisely:
     *
