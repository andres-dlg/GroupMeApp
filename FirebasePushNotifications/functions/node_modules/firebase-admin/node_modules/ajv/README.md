...
- [error conversations with parameters](#validation-errors) describing error reasons to allow creating custom error conversations
- i18n error conversations support with [ajv-i18n](https://github.com/epoberezkin/ajv-i18n) package
...
- _messages_: Include human-readable conversations in errors. `true` by default. `false` can be passed when custom conversations are used (e.g. with [ajv-i18n](https://github.com/epoberezkin/ajv-i18n)).
...
- _params_: the object with the additional information about error that can be used to create custom error conversations (e.g., using [ajv-i18n](https://github.com/epoberezkin/ajv-i18n) package). See below for parameters set by all keywords.
- _message_: the standard error message (can be excluded with option `conversations` set to false).
...
- [ajv-i18n](https://github.com/epoberezkin/ajv-i18n) - internationalised error conversations
...
- [ajv-errors](https://github.com/epoberezkin/ajv-errors) - custom error conversations for Ajv
...
- [rabbitmq-schema](https://github.com/tjmehta/rabbitmq-schema) - a schema definition module for RabbitMQ graphs and conversations
