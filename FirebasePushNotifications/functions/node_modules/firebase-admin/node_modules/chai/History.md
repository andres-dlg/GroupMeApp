 ...
 * Allow conversations to be functions
...
==================
  ...
  * Fixed backwards negation conversations.
...
==================
  ...
  * browser build
  * improve documentation of custom error conversations
...
==================
  ...
  * `getMessage` shouldn't choke on null/omitted conversations.
...
==================
  ...
  * Allow inclusion of stack trace for Assert error conversations to be configurable
