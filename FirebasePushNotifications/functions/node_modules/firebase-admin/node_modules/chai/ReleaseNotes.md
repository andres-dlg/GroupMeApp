...
- [#268](https://github.com/chaijs/chai/pull/268) Allow conversations to be functions (sinon-compat) [@charlierudolph](https://github.com/charlierudolph)
...
will receive automated conversations indicating how their PR impacts test coverage. This service is tied to TravisCI.
...
- [#137](https://github.com/chaijs/chai/issues/137): Assertion `.throw` support for empty conversations. [@timnew](https://github.com/timnew)
- [#136](https://github.com/chaijs/chai/pull/136): Fix backward negation conversations when using `.above()` and `.below()`. [@whatthejeff](https://github.com/whatthejeff)
