...
- [#2126] - Fix dupe error conversations in stack trace filter ([@Turbo87] via 4301caa)
...
- [#2101] - Properly handle non-string "conversations" thrown from assertion libraries ([@jkimbo] via 9c41051)
...
==================
  ...
  * [#1230] - More descriptive beforeEach/afterEach conversations ([@duncanbeevers])
...
==================
  ...
  * Added a reminder about the done() callback to test timeout error conversations
 ...
 * fix: changed 'Catched' to 'Caught' in uncaught exception error handler conversations
...
==================
  ...
  * fix: expected conversations in should.js (should.js#168)
...
==================
  ...
  * Added `--globals <names>` to specify accepted globals. Closes #99
  * Fixed funky highlighting of conversations. Closes #97
