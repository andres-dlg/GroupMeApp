...
* [enhancement] Better error conversations for invalid source files (#1480)
...
* [enhancement] Better `ban` rule failure conversations (#1385)
...
* [enhancement] Failure conversations are clearer and more consistent for many rules (#1303, #1307, #1309)
...
* **BREAKING CHANGES**
    * all error conversations now start with a lower-case character and do not end with a period
