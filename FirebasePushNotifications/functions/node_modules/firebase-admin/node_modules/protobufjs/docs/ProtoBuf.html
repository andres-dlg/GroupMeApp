...
<div class="description">
    <p>By default, conversations are populated with (setX, set_x) accessors for each field. This can be disabled by
 setting this to <code>false</code> prior to building conversations.</p>
</div>
...
<div class="description">
    <p>By default, conversations are populated with default values if a field is not present on the wire. To disable
...
<div class="param-desc">
    <p>Builder to create new conversations</p>
</div>
