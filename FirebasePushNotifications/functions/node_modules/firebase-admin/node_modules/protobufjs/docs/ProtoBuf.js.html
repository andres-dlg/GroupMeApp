...
(function(global, factory) {
    ...
    /**
     * By default, conversations are populated with (setX, set_x) accessors for each field. This can be disabled by
     *  setting this to `false` prior to building conversations.
     * @type {boolean}
     * @expose
     */
    ...
    /**
     * By default, conversations are populated with default values if a field is not present on the wire. To disable
    ...
    ProtoBuf.Reflect = (function(ProtoBuf) {
        ...
        var Element = function(type, resolvedType, isMapKey, syntax, name) {
            ...
            /**
             * Name of the field containing this element (for error conversations)
             * @type {string}
             */
            this.name = name;
        ...
        MessagePrototype.build = function(rebuild) {
            ...
            var clazz = (function(ProtoBuf, T) {
                 ...
                 * @class Barebone of all runtime conversations.
            ...
            // Static enums and prototyped sub-conversations / cached collections
            this._fields = [];
            this._fieldsById = {};
            this._fieldsByName = {};
            this._oneofsByName = {};
        ...
        MessagePrototype.decode = function(buffer, length, expectedGroupEndId) {
            ...
            while (buffer.offset &lt; start+length || (length === -1 &amp;&amp; buffer.remaining() > 0)) {
                ...
                if (!(field = this._fieldsById[id])) {
                    // "conversations created by your new code can be parsed by your old code: old binaries simply ignore the new field when parsing."
                    switch (wireType) {
                        case ProtoBuf.WIRE_TYPES.VARINT:
                            buffer.readVarint32();
                            break;
    ...
    ProtoBuf.Builder = (function(ProtoBuf, Lang, Reflect) {
         ...
         * @class Provides the functionality to build protocol conversations.
         * @param {Object.&lt;string,*>=} options Options
         * @constructor
         */
        ...
        BuilderPrototype.create = function(defs) {
            ...
            while (stack.length > 0) {
                ...
                while (defs.length > 0) {
                    var def = defs.shift(); // Namespaces always contain an array of conversations, enums and services
                    ...
                    if (Builder.isMessage(def)) {
                        ...
                        if (def["conversations"])
                            def["conversations"].forEach(function(msg) {
                                subObj.push(msg);
                            });
                        if (def["services"])
        ...
        function propagateSyntax(parent) {
            if (parent['conversations']) {
                parent['conversations'].forEach(function(child) {
        ...
        BuilderPrototype["import"] = function(json, filename) {
            ...
            if (json['conversations'])
                this.create(json['conversations']),
                this.ptr = base;
            if (json['enums'])
        ...
        BuilderPrototype.resolveAll = function() {
            ...
            if (this.ptr instanceof Reflect.Namespace) { // Resolve children
                ...
                // (i.e., no enums or conversations), so we don't need to resolve against the current namespace.
                if (this.ptr.map) {
     ...
     * @return {ProtoBuf.Builder} Builder to create new conversations
