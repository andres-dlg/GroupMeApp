 ...
 *    of the `event.params` object. For example, `ref("conversations/{messageId}")`
 *    matches changes at `/conversations/message1` or `/conversations/message2`, resulting
...
export declare class DeltaSnapshot {
    private app;
    private adminApp;
    instance: string;
    private _adminRef;
    ...
    private _childPath;
    private _isPrevious;
    constructor(app: firebase.app.App, adminApp: firebase.app.App, data: any, delta: any, path?: string, instance?: string);
